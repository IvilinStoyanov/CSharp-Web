...
namespace Pepper.Web.Controllers
{
    ...
    {
        private SignInManager<PepperUser> signIn;
        private UserManager<PepperUser> userManager;

        public AccountController(SignInManager<PepperUser> signIn, UserManager<PepperUser> userManager)
        {
            this.signIn = signIn;
